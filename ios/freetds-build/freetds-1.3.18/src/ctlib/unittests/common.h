...
CS_RETCODE try_ctlogin(CS_CONTEXT ** ctx, CS_CONNECTION ** request, CS_COMMAND ** cmd, int verbose);
CS_RETCODE try_ctlogin_with_options(int argc, char **argv, CS_CONTEXT ** ctx, CS_CONNECTION ** request, CS_COMMAND ** cmd,
				    int verbose);

CS_RETCODE try_ctlogout(CS_CONTEXT * ctx, CS_CONNECTION * request, CS_COMMAND * cmd, int verbose);
